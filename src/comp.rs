...
#[doc = "`write(|w| ..)` method takes [acris::W](acris::W) writer structure"]
impl crate::Writable for ACRIS {}
#[doc = "Analog Comparator Raw Interrupt Status"]
pub mod acris;
...
#[doc = "`write(|w| ..)` method takes [acstat0::W](acstat0::W) writer structure"]
impl crate::Writable for ACSTAT0 {}
#[doc = "Analog Comparator Status 0"]
pub mod acstat0;
...
#[doc = "`write(|w| ..)` method takes [acstat1::W](acstat1::W) writer structure"]
impl crate::Writable for ACSTAT1 {}
#[doc = "Analog Comparator Status 1"]
pub mod acstat1;
