...
#[doc = "Reader of field `QEI_MAXPOS`"]
pub type QEI_MAXPOS_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `QEI_MAXPOS`"]
pub struct QEI_MAXPOS_W<'a> {
    w: &'a mut W,
}
impl<'a> QEI_MAXPOS_W<'a> {
...
impl R {
    ...
    pub fn qei_maxpos(&self) -> QEI_MAXPOS_R {
        QEI_MAXPOS_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - Maximum Position Integrator Value"]
