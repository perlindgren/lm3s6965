...
#[doc = "Reader of field `TIMER_TBPR_TBPSR`"]
pub type TIMER_TBPR_TBPSR_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `TIMER_TBPR_TBPSR`"]
pub struct TIMER_TBPR_TBPSR_W<'a> {
    w: &'a mut W,
}
impl<'a> TIMER_TBPR_TBPSR_W<'a> {
